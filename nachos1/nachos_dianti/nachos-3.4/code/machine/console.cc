...
static Semaphore *readok=new Semaphore("readok",0);
static Semaphore *writeok=new Semaphore("writeok",0);

static void ReadOk(int arg)
{
	readok->V();
}

static void WriteOk(int arg)
{
        writeok->V();
}
...
SynchConsole::SynchConsole(char *readfile,char *writefile)
{
	...
	console=new Console(readfile,writefile,ReadOk,WriteOk,0);
}
